        ...
        <div className="col-span-2 grid gap-4">
          <Card>
            <div className='flex gap-4 justify-around flex-wrap mb-4'>
              <div>
                <p className='text-sm text-slate-400 font-medium mb-1'>Borrowable Fund </p>
                <h1 className='text-2xl font-bold'> $ {borrowoableAmount} </h1>
              </div>
              <div>
                <p className='text-sm text-slate-400 font-medium mb-1'>Collateral Donated </p>
                <h1 className='text-2xl font-bold'> $ {collateralAmount} </h1>
              </div>
              <div>
                <p className='text-sm text-slate-400 font-medium mb-1'>Borrowed Donation </p>
